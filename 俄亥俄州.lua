...
local Window = OrionLib:MakeWindow({Name = '暗红脚本', HidePremium = false, SaveConfig = true, ConfigFolder = 'OrionTest', IntroText = '暗红脚本'})
...
Home:AddParagraph('按红脚本缝合制作','官方QQ群942272935')
Home:AddDropdown({
    Name = '脚本',
    Default = '',
